...
object Titanic {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession
      .builder()
      .master("spark://raintungmaster:7077")
      .appName("Titanic")
      .getOrCreate()
 
   // import spark.implicits._

    val (dataDFRaw, predictDFRaw) = loadData("hdfs://192.168.121.101:9000/kaggle/train.csv", "hdfs://192.168.121.101:9000/kaggle/test.csv", spark)
    ...
    predictions
      ...
      .format("csv")
      .option("header", "true")
      .save("hdfs://192.168.121.101:9000/kaggle/result")
  }
